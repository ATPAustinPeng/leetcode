...
| 169       | Majority Element                                       | 2 (ALMOST) | # removed majority element always <= # removed nonmajority element                     |
...
| 400       | Nth Digit                                              |            |                                                                                        |
| 409       | Longest Palindrome                                     | 2 (DONE)   | use static array when length is known                                                  |
...
| 973       | K Closest Points to Origin                             | 1 (ALMOST) | find way to get k smallest distances (can calc distances twice)                        |
